...
\begin{document}
		...
		\begin{abstract}
			...
			El nombre que le he dado a mi solución es GRecommender. Éste se basa en un sistema de recomendaciones con una base de datos orientada a grafos que da soporte a todo el sistema. El frontal se comunica con la base de datos modificando ésta creando nuevos vértices al insertar un nuevo usuario y aristas en el caso de las recomendaciones. \\
		...
		\section{Metodología de trabajo}
			...
			La preparación de los datos a sido a partir de un scraper en Java. El funcionamiento es el siguiente: Busque información sobre filmaffinity y como descargarse la información de cada una de estas películas. Encontré varios sitios pero me decante por hacerlo a mano, ya que a partir de el end-point solo tenia que añadir un numero de identificación, yo he cogido los id aleatorios y los he guardado en un archivo siempre que devolviera el código de respuesta 200. Con estos id's de las películas realicé de nuevo las peticiones pero esta vez he descargado toda la siguiente información por película de filmaffinity.\\
		...
		Esto sería una simulación de la aplicacación, es totalmente teórica ya que por falta de tiempo no he podido completar toda la aplicación, sobretodo la parte de visualización.
